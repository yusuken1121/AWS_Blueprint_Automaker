...

{
  ...
  "architectureDiagram": string, // **重要: Mermaid.js形式の図解コード (graph TD/LR)。システム構成図であり、「どうデータが流れるか」や「誰が何をするか」がわかる概念図にしてください。5-15個くらいのノードにしてください。構文エラーを防ぐため、- 記号（"()", "[]", """", "''"）の厳禁。- AWSのサービスは必ず英語で書いてください。例: A["User"] --> B["Amazon S3 (倉庫)"]**
